...
use App\Models\MusnadAhmedModel;
use Illuminate\Console\Command;
use Goutte;
class ScrapeMusnadAhmedData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrape:MusnadAhmedData';
    ...
    {
        $this->output->writeln('Scraper Running For Musnad Ahmed');

        for ($i = 1; $i <= 13440; $i++) {
            $url = "https://www.quranohadith.com/hadees-details/musnad-ahmed/{$i}";
            ...
            $hadeesModel = new MusnadAhmedModel();
