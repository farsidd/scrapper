...
use App\Models\TirmaziModel;
use Illuminate\Console\Command;
use Goutte;
class ScrapeTirmaziData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrape:TirmaziData';
    ...
    {
        $this->output->writeln('Scraper Running For Tirmazi');

        for ($i = 1; $i <= 3956; $i++) {
            $url = "https://www.quranohadith.com/hadees-details/tirmazi/{$i}";
