...
use App\Models\MishkatModel;
use Illuminate\Console\Command;
use Goutte;
class ScrapeMishkatData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrape:MishkatData';
    ...
    {
        $this->output->writeln('Scraper Running For Mishkat');

        for ($i = 1; $i <= 6294; $i++) {
            $url = "https://www.quranohadith.com/hadees-details/mishkat/{$i}";
