...
use App\Models\IbnEMajaModel;
use Illuminate\Console\Command;
use Goutte;
class ScrapeIbnEMajaData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrape:IbnEMaja';
    ...
    {
        $this->output->writeln('Scraper Running For Ibn E Maja');

        for ($i = 1; $i <= 4341; $i++) {
            $url = "https://www.quranohadith.com/hadees-details/ibn-e-maja/{$i}";
