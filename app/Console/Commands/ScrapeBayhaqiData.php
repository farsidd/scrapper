...
use App\Models\BayhaqiModel;
use Illuminate\Console\Command;
use Goutte;
class ScrapeBayhaqiData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrape:BayhaqiData';
    ...
    {
        $this->output->writeln('Scraper Running For Bayhaqi');

        for ($i = 1; $i <= 21818; $i++) {
            $url = "https://www.quranohadith.com/hadees-details/bayhaqi/{$i}";
