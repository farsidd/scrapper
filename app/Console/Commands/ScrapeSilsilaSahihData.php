...
use App\Models\SilsilaSahihModel;
use Illuminate\Console\Command;
use Goutte;
class ScrapeSilsilaSahihData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'scrape:SilsilaSahih';
    ...
    {
        $this->output->writeln('Scraper Running For Silsila Sahih');

        for ($i = 1; $i <= 3704; $i++) {
            $url = "https://www.quranohadith.com/hadees-details/silsila-sahih/{$i}";
            ...
            $hadeesModel = new SilsilaSahihModel();
